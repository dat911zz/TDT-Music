...
namespace TDT.Core.DTO
{
    ...
    public class SongDTO : APIResponseModel
    {
        ...
        [FirestoreProperty] public  Dictionary<string, string> artists { get => _artists; set => _artists = value; }
        ...
        [FirestoreProperty] public  Dictionary<string, string> composers { get => _composers; set => _composers = value; }
