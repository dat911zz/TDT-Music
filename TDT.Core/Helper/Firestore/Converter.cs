...
namespace TDT.Core.Helper.Firestore
{
    ...
    {
        public static TypePlaylistDTO convertToTypePlayListDTO(TypePlayList typePlayList)
        {
        ...
        public static PlaylistDTO convertToPlaylistDTO(Playlist playlist)
        {
            ...
            if (playlist.artists != null)
            {
                ...
                {
                    result.artists.Add(artist.alias);
                }
            }
        ...
        public static SectionDTO convertToSectionDTO(Section section)
        {
            ...
            if (section.items != null)
            {
                ...
                {
                    result.items.Add(String.IsNullOrEmpty(item.alias) ? item.title : item.alias);
                }
            }
        ...
        public static SongDTO convertToSongDTO(Song song)
        {
            ...
            if (song.composers != null)
            {
                ...
                {
                    result.composers.Add(composer.alias);
                }
            }
            if (song.album != null)
            {
        ...
        //    return result;
        //}
        public static ArtistDTO convertToArtistDTO(Core.DTO.ArtistDTO artist)
        {
            ArtistDTO result = new ArtistDTO();
            result.id = artist.id;
            result.name = artist.name;
            ...
            result.totalFollow = artist.totalFollow;
            result.follow = artist.follow;
            result.sections = new List<SectionDTO>();
            if (artist.sections != null)
            {
                foreach (Core.DTO.SectionDTO section in artist.sections.Values)
                {
                    result.sections.Add(convertToSectionDTO(section));
                }
            }
            result.sectionId = artist.sectionId;
            result.hasOA = artist.hasOA;
